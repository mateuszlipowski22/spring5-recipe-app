...
public class ImageController {
    ...
    public String showUploadFile(@PathVariable String id, Model model){
    ...
    private void renderImageFromDB(@PathVariable String id, HttpServletResponse response) throws IOException {
