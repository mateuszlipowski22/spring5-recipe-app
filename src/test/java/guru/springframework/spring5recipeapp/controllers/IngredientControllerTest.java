...
import guru.springframework.spring5recipeapp.services.IngredientServiceImpl;
...
class IngredientControllerTest {
    ...
    public void testDeleteIngredients() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/recipe/2/ingredient/3/delete")
                ...
                .param("id","")
                .param("description", "some string"))
                .andExpect(status().is3xxRedirection()).andExpect(view().name("redirect:/recipe/2/ingredients"));
